...
var testpage = "test4.php?seed=" + seed + "&numMovie="+numMovie+ "&logid="+logid+"&rtsp="+rtsp +"&rtspopt="+rtspopt + "&hd720=" + hd720 + "&hd1080=" + hd1080 + "&loglevel=" + loglevel + "&debugflag=" + debugflag;

$(document).ready(function() {

		logMessage("test6 start");
	...
	function setEmpty()
	{
		...
		logMessage("t6 openpage  empty page");
	...
	function setTestPage()
	{
		...
		logMessage("t6 openpage  test4 page");
