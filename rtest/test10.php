...
$(document).ready(function() {
	...
	function testMovie()
	{
		...
		{
			document.getElementById("state").innerHTML = (waitnum+1)+"/"+waits.length+" Wait for success: "+message;
			timeout = 60000;
		}
	}//testmov
		...
		function timeUpdate()
		{
			...
			if(stmask || stvalue)
			{
				document.getElementById("timeleft").innerHTML = timeout;
			}
			else
			{
